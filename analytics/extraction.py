...
def _resolve_save_defender(
    ...
    defenders: list[tuple[float, str, str, str]] = []
    ...
    if np.isnan(best_dist) or best_dist > 1200.0:
        return None
    ...
    if not shot_df.empty:
        for idx, row in shot_df.iterrows():
            ...
            if result == "Goal":
                ...
                save_defender = _resolve_save_defender(
                    game_df=game_df,
                    proto=proto,
                    hits=hits,
                    pid_name=pid_name,
