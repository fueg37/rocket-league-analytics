...
from analytics.schema import AnalyticsTables, EventType, SCHEMA_VERSION, canonicalize_event_types, normalize_tables
...
def build_schema_tables(manager, game_df: pd.DataFrame, proto, match_id: str, file_name: str, shot_df: pd.DataFrame) -> AnalyticsTables:
    ...
    event_df = canonicalize_event_types(pd.DataFrame(event_rows))
